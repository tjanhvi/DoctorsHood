        ...
        <div className='sm:flex sm:flex-row'>
          ...
          <div className='basis-4/5 img-parent1'>
            <div className='sm:pt-4 sm:pl-4 sm:flex sm:flex-row'>
              ...
              <select name="degree" id="degree" className='border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:w-56'>
        ...
        <div className='sm:flex sm:flex-row'>
          ...
          <div className='basis-4/5 img-parent1'>
            <div className='sm:pt-4 sm:pl-4 sm:flex sm:flex-row'>
              ...
              <select name="specialisation" id="specialisation" className='border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:w-56'>
                <option value="">Select Specialisation</option>
                <option value="">Specialisation 1</option>
                <option value="">Specialisation 2</option>
                <option value="">Specialisation 3</option>
              </select>
              </div>
              <div className="sm:basis-1/2">
              ...
              <select name="diseases" id="diseases" className='border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:w-56'>
                <option value="">Select Diseases</option>
                <option value="">Disease 1</option>
                <option value="">Disease 2</option>
                <option value="">Disease 3</option>
              </select>
              </div>
            </div>
          </div>
        ...
        <div className='sm:flex sm:flex-row'>
          ...
          <div className='basis-4/5 img-parent1'>
            <div className='sm:pt-4 sm:pl-4 sm:flex sm:flex-row'>
              ...
              <input type="number" id="experience" placeholder="Enter Years of experience" className='border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:w-56'/>
              </div>
              <div className="sm:basis-1/2">
